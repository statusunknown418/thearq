  ...
  "inline-flex items-center gap-1.5 select-none justify-center whitespace-nowrap text-xs font-medium transition-all outline-none focus-visible:ring focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80 border border-border/80 dark:border-border-contrast/80 hover:border-primary/50 dark:hover:border-border-contrast active:border-border active:bg-secondary",
        ghost:
