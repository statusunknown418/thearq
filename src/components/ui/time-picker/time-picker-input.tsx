...
import { getArrowByType, getDateByType, setDateByType, type TimePickerType } from "./utils";
  ...
  (
    ...
    return (
      <Input
        ...
        name={name ?? picker}
        className={cn(
          "w-[48px] text-center font-mono text-base tabular-nums caret-transparent hover:border-primary/60 focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none",
          className,
        )}
